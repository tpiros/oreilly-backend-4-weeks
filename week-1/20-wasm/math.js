...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_square')) {
        Object.defineProperty(Module['ready'], '_square', { configurable: true, get: function() { abort('You are getting _square on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_square', { configurable: true, set: function() { abort('You are setting _square on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_cube')) {
        Object.defineProperty(Module['ready'], '_cube', { configurable: true, get: function() { abort('You are getting _cube on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_cube', { configurable: true, set: function() { abort('You are setting _cube on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _square = Module["_square"] = createExportWrapper("square");

/** @type {function(...*):?} */
var _cube = Module["_cube"] = createExportWrapper("cube");
